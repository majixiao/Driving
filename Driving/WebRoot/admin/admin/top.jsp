...
<link href="${pageContext.request.contextPath}/admin/css/Style1.css"
...
<body>
	<table width="100%" height="70%" border="0" cellspacing="0"
		...
		<tr>
			<td><img width="100%"
				src="${pageContext.request.contextPath}/admin/images/top_01.jpg"></td>

			<td width="100%"
				background="${pageContext.request.contextPath}/admin/images/top_100.jpg">
			</td>
		</tr>
	</table>
