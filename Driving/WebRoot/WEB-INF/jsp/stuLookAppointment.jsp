	...
	<div id="wrapper">
		...
		<s:actionerror></s:actionerror>
			<table class="altrowstable" id="alternatecolor"
				...
				<s:iterator value="pageBean.list" var="appintment" status="I">
					...
					<tr>
						...
						<td><s:property value="#appintment.pname" /></td>
						<td><s:property value="#appintment.pnumber" /></td>
						<td><s:property value="#appintment.pstarttime" /></td>
						<td><s:property value="#appintment.pdesc" />
						</td>
						<td><s:property value="#appintment.premaining" /></td>

						<td><s:property value="#appintment.pdate" /></td>
						<td><a
							href="${pageContext.request.contextPath}/students_selectBycid?cid=<s:property
									value="#appintment.coach.cid" />"><s:property
									value="#appintment.coach.cname" /> </a></td>
					</tr>
				</s:iterator>
			...
			<s:elseif test="pageBean.page==1">
				<a
					href="${pageContext.request.contextPath}/students_lookAppointment?page=<s:property value="pageBean.page+1"/>">下一页</a>&nbsp&nbsp
			<a
					href="${pageContext.request.contextPath}/students_lookAppointment?page=<s:property value="pageBean.totalPage"/>">尾页</a>
			...
			<s:elseif test="pageBean.page>1&&pageBean.page<pageBean.totalPage">
				<a
					href="${pageContext.request.contextPath}/students_lookAppointment?page=1">首页</a>&nbsp&nbsp
			<a
					href="${pageContext.request.contextPath}/students_lookAppointment?page=<s:property value="pageBean.page-1"/>">上一页</a>&nbsp&nbsp
			<a
					href="${pageContext.request.contextPath}/students_lookAppointment?page=<s:property value="pageBean.page+1"/>">下一页</a>&nbsp&nbsp
			<a
					href="${pageContext.request.contextPath}/students_lookAppointment?page=<s:property value="pageBean.totalPage"/>">尾页</a>&nbsp&nbsp
			&nbsp&nbsp第<s:property value="pageBean.page" />页/共<s:property
					value="pageBean.totalPage" />页
			</s:elseif>
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			<s:elseif test="pageBean.page==pageBean.totalPage">
				<a
					href="${pageContext.request.contextPath}/students_lookAppointment?page=1">首页</a>&nbsp&nbsp
			<a
					href="${pageContext.request.contextPath}/students_lookAppointment?page=<s:property value="pageBean.page-1"/>">上一页</a>
			&nbsp&nbsp第<s:property value="pageBean.page" />页/共<s:property
					value="pageBean.totalPage" />页
			</s:elseif>
			<li></li>
