	...
	<div id="wrapper">
		...
		<section id="content">
			...
			<table class="altrowstable" id="alternatecolor"
				...
				<s:iterator value="pageBean.list" var="appintment" status="I">
					...
					<tr>
						...
						<td><s:property value="#appintment.pdesc" /></td>
						...
						<td><a
							href="${pageContext.request.contextPath}/students_selectBycid?cid=<s:property
									value="#appintment.coach.cid" />"><s:property
									value="#appintment.coach.cname" /> </a>
						</td>
						<s:set name="nowTime" value="new java.util.Date()"></s:set>
						<s:if test="#appintment.premaining>0&&#appintment.pstarttime.getTime()>#nowTime.getTime()">
						<td><a
							href="${pageContext.request.contextPath}/record_recordAppointment?pid=<s:property
									value="#appintment.pid" />"
							onclick="return confirm('请确认是否预约？')">预约 </a></td>
							</s:if >
							<s:elseif test="#appintment.premaining=0">
							<td>人数已满</td>
							</s:elseif>
							<s:else>
							<td>预约已过期</td>
			...
			<s:elseif test="pageBean.page==1">
				<a
					href="${pageContext.request.contextPath}/students_stuRecordAppointment?page=<s:property value="pageBean.page+1"/>">下一页</a>&nbsp&nbsp
			<a
					href="${pageContext.request.contextPath}/students_stuRecordAppointment?page=<s:property value="pageBean.totalPage"/>">尾页</a>
			...
			<s:elseif test="pageBean.page>1&&pageBean.page<pageBean.totalPage">
				<a
					href="${pageContext.request.contextPath}/students_stuRecordAppointment?page=1">首页</a>&nbsp&nbsp
			<a
					href="${pageContext.request.contextPath}/students_stuRecordAppointment?page=<s:property value="pageBean.page-1"/>">上一页</a>&nbsp&nbsp
			<a
					href="${pageContext.request.contextPath}/students_stuRecordAppointment?page=<s:property value="pageBean.page+1"/>">下一页</a>&nbsp&nbsp
			<a
					href="${pageContext.request.contextPath}/students_stuRecordAppointment?page=<s:property value="pageBean.totalPage"/>">尾页</a>&nbsp&nbsp
			&nbsp&nbsp第<s:property value="pageBean.page" />页/共<s:property
					value="pageBean.totalPage" />页
			</s:elseif>
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			<s:elseif test="pageBean.page==pageBean.totalPage">
				<a
					href="${pageContext.request.contextPath}/students_stuRecordAppointment?page=1">首页</a>&nbsp&nbsp
			<a
					href="${pageContext.request.contextPath}/students_stuRecordAppointment?page=<s:property value="pageBean.page-1"/>">上一页</a>
			&nbsp&nbsp第<s:property value="pageBean.page" />页/共<s:property
					value="pageBean.totalPage" />页
			</s:elseif>
			<li></li>
