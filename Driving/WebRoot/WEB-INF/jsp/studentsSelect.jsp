	...
	function select() {
		if (document.getElementById("sname").value != "")
			window.location.href = "${pageContext.request.contextPath}/coachSelect_selectBysname?sname="
					+ encodeURI(encodeURI(document.getElementById("sname").value));
		else {
			alert("请输入名字！！！");
		}
	}
	...
	<div id="wrapper">
		...
		<section id="inner-headline">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<h2 class="pageTitle">学员信息</h2>
					</div>
				</div>
			</div>
		</section>
		<li></li> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text"
			align="center" placeholder="请输入学员姓名" id="sname"> <a
			style="
cursor:pointer" onclick="select()">查询</a>
		...
		<section id="content">
			<table class="altrowstable" id="alternatecolor"
				...
				<s:iterator value="pageBean.list" var="student" status="I">
					...
					<td><s:property value="#I.index+1" />
						...
						<td><s:property value="#student.ssex" />
						</td>
						<td><s:property value="#student.sage" />
						</td>
						<td><s:property value="#student.sphone" />
						</td>
						<td><s:iterator value="#student.records" var="record">
						(<s:property value="#record.appointment.pid" />)
						</s:iterator>
						</td>
					</tr>
				</s:iterator>
			...
			<s:elseif test="pageBean.page==1">
				<a
					href="${pageContext.request.contextPath}/page_studentsSelect?page=<s:property value="pageBean.page+1"/>">下一页</a>&nbsp&nbsp
			<a
					href="${pageContext.request.contextPath}/page_studentsSelect?page=<s:property value="pageBean.totalPage"/>">尾页</a>
			...
			<s:elseif test="pageBean.page>1&&pageBean.page<pageBean.totalPage">
				<a
					href="${pageContext.request.contextPath}/page_studentsSelect?page=1">首页</a>&nbsp&nbsp
			<a
					href="${pageContext.request.contextPath}/page_studentsSelect?page=<s:property value="pageBean.page-1"/>">上一页</a>&nbsp&nbsp
			<a
					href="${pageContext.request.contextPath}/page_studentsSelect?page=<s:property value="pageBean.page+1"/>">下一页</a>&nbsp&nbsp
			<a
					href="${pageContext.request.contextPath}/page_studentsSelect?page=<s:property value="pageBean.totalPage"/>">尾页</a>&nbsp&nbsp
			&nbsp&nbsp第<s:property value="pageBean.page" />页/共<s:property
					value="pageBean.totalPage" />页
			</s:elseif>
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			<s:elseif test="pageBean.page==pageBean.totalPage">
				<a
					href="${pageContext.request.contextPath}/page_studentsSelect?page=1">首页</a>&nbsp&nbsp
			<a
					href="${pageContext.request.contextPath}/page_studentsSelect?page=<s:property value="pageBean.page-1"/>">上一页</a>
			&nbsp&nbsp第<s:property value="pageBean.page" />页/共<s:property
					value="pageBean.totalPage" />页
			</s:elseif>
			<li></li>
