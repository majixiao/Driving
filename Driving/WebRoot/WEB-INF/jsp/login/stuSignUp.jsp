	...
	<div class="container">
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
				...
				<!-- Start Sign In Form -->
				<h2 style="float: left">学员注册</h2>
				<a href="${pageContext.request.contextPath}/registered_coachSignUp">
					<h3
						style="float: right; filter:alpha(opacity=50);-moz-opacity:0.5;opacity:0.5;">教员注册</h3>
				</a>
				<form validate="ture"
					action="${pageContext.request.contextPath}/students_registered"
					class="fh5co-form animate-box" data-animate-effect="fadeIn"
					method="post">
					<div class="form-group">
						<label for="sname" class="sr-only">Name</label> <input type="text"
							class="form-control" id="sname" placeholder="姓名" name="sname"
							autocomplete="off">
						<s:fielderror fieldName="sname"></s:fielderror>
					</div>
					<div class="form-group">
						<label for="sphone" class="sr-only">Phone</label> <input
							type="text" class="form-control" id="sphone" placeholder="手机号"
							name="sphone" autocomplete="off" onblur="sphonecheck()">
						<s:fielderror fieldName="sphone"></s:fielderror>
						<div id="span_content"></div>
					</div>
					<div class="form-group">
						<label for="sage" class="sr-only">Age</label> <input type="text"
							class="form-control" id="sage" placeholder="请输入5~80 年龄"
							name="sage" autocomplete="off" onblur="numberCheck()">
						<s:fielderror fieldName="sage"></s:fielderror>
					</div>
					<div class="form-group">
						<label for="email" class="sr-only">Email</label> <input
							type="email" class="form-control" id="email" placeholder="qq邮箱"
