	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
				...
				<!-- Start Sign In Form -->
				<form action="${pageContext.request.contextPath}/students_login"
					class="fh5co-form animate-box" data-animate-effect="fadeIn"
					method="post">

					<font color="black"><s:actionerror /> </font>
					<div class="form-group">
						<label for="username" class="sr-only">Username</label> <input
							type="text" class="form-control" id="sphone" name="sphone"
							placeholder="手 机 号" autocomplete="off">
					</div>
					<div class="form-group">
						<label for="password" class="sr-only">Password</label> <input
							type="password" class="form-control" id="password"
							placeholder="Password" autocomplete="off" name="spw">
					</div>
					...
					<div class="form-group">
						...
						<p>
							未注册? <a
								href="${pageContext.request.contextPath}/registered_stuSignUp">注册</a>
							| <a href="${pageContext.request.contextPath}/page_forget">忘记密码?</a>
						</p>
					</div>
					<div class="form-group">
